...
INSERT INTO `facilities_used` VALUES (1,1,NULL,'dormitories'),(2,2,NULL,'dormitories'),(3,3,7,'conference_halls'),(4,4,9,'conference_halls'),(5,5,26,'cottages_guesthouses'),(6,6,NULL,'dormitories'),(7,7,30,'cottages_guesthouses'),(8,8,3,'conference_halls'),(9,9,4,'conference_halls'),(10,10,9,'conference_halls'),(11,6,NULL,'dining_kitchen'),(12,6,NULL,'conference_halls'),(26,11,NULL,'dormitories'),(27,12,NULL,'dormitories'),(28,13,36,'cottages_guesthouses'),(29,14,NULL,'dormitories'),(30,18,5,'conference_halls'),(31,18,3,'conference_halls'),(32,18,4,'conference_halls'),(33,21,NULL,'dormitories'),(34,22,NULL,'cottages_guesthouses'),(35,22,NULL,'conference_halls');
...
CREATE TABLE `reservations` (
  ...
  `telehone_no` varchar(45) DEFAULT NULL,
  `contact_no` varchar(45) NOT NULL DEFAULT '09999999999',
...
INSERT INTO `reservations` VALUES (1,' MT. PROVINCES MISSION VALENTIN APLOD','deped','organization','2017-06-28','2017-07-02',500,'0744436083','09277194794','seminar','request',NULL,NULL),(2,'NORTH/WESTERN LUZON-BENGUET','deped','organization','2017-07-07','2017-07-09',1000,NULL,'09162916353','seminar','request',NULL,NULL),(3,'ATE BETTY CALPITO','private','individual','2017-07-07','2017-07-07',1,NULL,'','wedding','request',NULL,NULL),(4,'CECILLE EGTAPEN','private','individual','2017-07-08','2017-07-08',5,NULL,'09218983384','birthday','request',NULL,NULL),(5,'DANILO ANGELES','private','individual','2017-07-11','2017-07-16',1,NULL,'','vacation','confirmed',NULL,NULL),(6,'DEPED C.O. DRRM-ICS','deped','organization','2017-07-12','2017-08-14',100,NULL,'','seminar','confirmed',NULL,NULL),(7,'DIR. DEMIE MANUEL','deped','individual','2017-07-14','2017-07-16',1,NULL,'','seminar','confirmed',NULL,NULL),(8,'AUD. ELLA','deped','organization','2017-07-15','2017-07-15',1,NULL,'','seminar','confirmed',NULL,NULL),(9,'DIANE DIEGO','private','individual','2017-07-15','2017-07-15',1,NULL,'09175730169','debut','confirmed',NULL,NULL),(10,'ABEGAIL OFRACIO','deped','organization','2017-07-16','2017-07-16',1,NULL,'09778255528','conference','unconfirmed',NULL,NULL),(11,'SMARTER PHILS','private','organization','2017-07-21','2017-07-23',300,NULL,'09999999999','seminar','unconfirmed',NULL,NULL),(12,'SPED/BLD CO.','deped','organization','2017-07-24','2017-07-26',71,'','09282236245','conference','cancelled',NULL,'2017-06-04'),(13,'LOLITA DE LEON','private','individual','2017-07-26','2017-07-28',1,NULL,'09228282782','vacation','request',NULL,NULL),(14,'APSAM YOUTH CONGRESS','private','organization','2017-07-27','2017-07-29',500,NULL,'09999999999','tour','confirmed','2017-07-01',NULL),(18,'PRC RADTECH. X-RAY TECH.','govt','organization','2017-07-30','2017-07-31',1,NULL,'09999999999','tour','cancelled',NULL,'2017-06-04'),(21,'UNITED METHODIST CHURCH/DARWIN POLICARPIO','govt','organization','2017-08-09','2017-08-11',750,'4244343','09309878107','seminar','request',NULL,NULL),(22,'DEPARTMENT OF AGRICULTURE-BAFS','govt','organization','2017-08-10','2017-08-11',10,NULL,'09999999999','conference','unconfirmed',NULL,NULL),(23,'BLD-WORKSHOP ON SPED OPERATIONAL MANUAL','deped','organization','2017-08-14','2017-08-23',89,'6319993','09282236245','workshop','cancelled',NULL,'2017-06-04'),(24,'VOUCHER SYSTEM ON SPED','deped','organization','2017-08-14','2017-08-18',53,'6319993','09238460653','seminar','unconfirmed',NULL,NULL),(25,'TESS GARCIA','private','individual','2017-08-19','2017-08-21',1,NULL,'09999999999','vacation','unconfirmed',NULL,NULL),(26,'PRC-VET','govt','organization','2017-08-15','2017-08-17',1,NULL,'09999999999','seminar','cancelled',NULL,'2017-06-04'),(27,'VVIXX ACAD','private','organization','2017-08-18','2017-08-20',500,NULL,'09999999999','tour','unconfirmed',NULL,NULL),(28,'LEONORA ROBIN/CORCILLOS','deped','organization','2017-08-21','2017-08-24',60,NULL,'09175412946','seminar','request',NULL,NULL),(29,'i-LEAD','private','organization','2017-08-25','2017-08-27',300,NULL,'09999999999','tour','unconfirmed',NULL,NULL),(30,'MR. DELA ROSA','private','individual','2017-08-25','2017-08-27',1,NULL,'09999999999','vacation','unconfirmed',NULL,NULL),(31,'DANILO DELA ROSA','private','individual','2017-08-25','2017-08-27',1,NULL,'09999999999','vacation','unconfirmed',NULL,NULL),(32,'DR. GEORGE TIZON','deped','organization','2017-08-25','2017-08-27',700,NULL,'09999999999','seminar','unconfirmed',NULL,NULL),(33,'LITO MALLARE','private','individual','2017-08-27','2017-08-29',1,NULL,'09999999999','tour','unconfirmed',NULL,NULL),(34,'PRC-PHARMACY','govt','organization','2017-08-30','2017-08-31',1,NULL,'09999999999','seminar','cancelled',NULL,'2017-06-04'),(35,'CMLI ELEM./WILLY FERRER','deped','organization','2017-08-31','2017-09-04',800,'029242304','09999999999','tour','confirmed','2017-07-14',NULL),(41,'PRC-FORESTERS','govt','organization','2017-09-12','2017-09-13',1,NULL,'09999999999','seminar','cancelled',NULL,'2017-06-04'),(42,'SMARTER PHILS','private','organization','2017-09-15','2017-09-17',400,NULL,'09999999999','tour','unconfirmed',NULL,NULL),(43,'BAGUIO BUDDIES/SCOTTISH RIGHT','private','organization','2017-09-15','2017-09-16',150,NULL,'09999999999','conference','unconfirmed',NULL,NULL),(44,'PRC-LIBRARIANS','govt','organization','2017-09-12','2017-09-13',1,NULL,'09999999999','seminar','cancelled',NULL,NULL),(45,'YOUTH-LEAD PHILS./MS.EMMA','private','organization','2017-09-22','2017-09-25',800,'5010357','09158974934','tour','request',NULL,NULL),(46,'DEPARTMENT OF AGRICULTURE - BAFS','govt','organization','2017-09-26','2017-09-27',45,NULL,'09999999999','conference','unconfirmed',NULL,NULL),(47,'DEPARTMENT OF AGRICULTURE - BAFS','govt','organization','2017-10-04','2017-10-06',60,NULL,'09999999999','conference','unconfirmed',NULL,NULL),(48,'APPSAM CHILDRENS CONGRESS','private','organization','2017-10-05','2017-10-07',400,NULL,'09999999999','congress','unconfirmed',NULL,NULL),(49,'JAAZIEL OBLIGACION','private','individual','2017-10-04','2017-10-13',1,NULL,'09081747044','vacation','unconfirmed',NULL,NULL),(50,'MS. ZENNY JANE SANTOS','private','individual','2017-10-05','2017-10-11',1,NULL,'09999999999','vacation','request',NULL,NULL),(51,'SMARTER PHILS.','private','individual','2017-10-13','2017-10-15',200,NULL,'09999999999','seminar','unconfirmed',NULL,NULL),(52,'MR. JOHN BATULAN','private','individual','2017-10-21','2017-10-21',1,NULL,'09062616874','conference','unconfirmed',NULL,NULL),(53,'NATIONAL CONF ON INCLUSIVE EDUC.','govt','organization','2017-10-24','2017-10-26',359,NULL,'09999999999','seminar','unconfirmed',NULL,NULL),(54,'NOPTI','private','organization','2017-10-26','2017-10-28',500,NULL,'09999999999','tor','unconfirmed',NULL,NULL);
...
-- Dump completed on 2017-06-15 16:38:21
